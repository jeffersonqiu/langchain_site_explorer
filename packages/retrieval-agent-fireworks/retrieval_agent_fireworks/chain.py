...
vectorstore_descriptions = (
    "A tool that looks up documentation about the LangChain Expression Language"
    "Use this tool to look anything up about LCEL or Runnable interface."
)
vectorstore_tool = create_retriever_tool(vectorstore_retriever, "docstore", vectorstore_descriptions)
